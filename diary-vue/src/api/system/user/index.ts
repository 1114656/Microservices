...
export const deleteUserList = (ids: number[]) => {
  return request.delete({ url: '/admin-api/system/user/delete-list', params: { ids: ids.join(',') } })
}

export const resetUserPassword = (id: number, password: string) => {
  return request.put({ url: '/admin-api/system/user/update-password', data: { id, password } })
}

export const updateUserStatus = (id: number, status: number) => {
  return request.put({ url: '/admin-api/system/user/update-status', data: { id, status } })
}

export const getSimpleUserList = (): Promise<UserVO[]> => {
  return request.get({ url: '/admin-api/system/user/simple-list' })
}
