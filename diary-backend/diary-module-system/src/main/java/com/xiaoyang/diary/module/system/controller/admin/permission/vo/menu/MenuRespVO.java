package com.xiaoyang.diary.module.system.controller.admin.permission.vo.menu;
...
public class MenuRespVO {
    ...
    @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小杨")
