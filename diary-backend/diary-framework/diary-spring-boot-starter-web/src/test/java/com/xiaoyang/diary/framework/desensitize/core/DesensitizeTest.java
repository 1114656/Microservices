package com.xiaoyang.diary.framework.desensitize.core;

import com.xiaoyang.diary.framework.common.util.json.JsonUtils;
import com.xiaoyang.diary.framework.desensitize.core.annotation.Address;
import com.xiaoyang.diary.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.xiaoyang.diary.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.xiaoyang.diary.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("小杨");
        ...
        desensitizeDemo.setRegex("你好，我是小杨");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("小杨");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "小杨", replacer = "*")
